...
-- 	('ACCOUNTS','ABC09', 20160103),
-- 	('IT','ABC11', 20170204),
-- 	('HR','ABC01', 20160405),
-- 	('HELPDESK', 'ABC10', 20170603),
-- 	('SALES', 'ABC06', 20170108);
...
-- UPDATE Employee SET Dno = 5, SUPERSSN = NULL WHERE SSN = 'ABC06';
-- UPDATE Employee SET Dno= 5, SUPERSSN = 'ABC06' WHERE SSN = 'ABC07';
...
-- 	('BIGDATA','BENGALURU',5),
-- 	('SENSORS','BENGALURU', 3),
-- 	('BANK MANAGEMENT','BENGALURU',1),
-- 	('SALARY MANAGEMENT','BANGALORE',1),
-- 	('OPENSTACK','BENGALURU',4),
-- 	('SMART CITY','BENGALURU',2);
